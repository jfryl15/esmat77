...
# پوشه‌ی ریشه‌ی کد (مطلق) - فایل‌های سورس و static همیشه این‌جا هستند.
BASE_DIR = os.path.dirname(os.path.abspath(__file__))

# مسیر داده‌های قابل‌نوشتن. در Railway، RAILWAY_VOLUME_MOUNT_PATH خودکار در
# زمان اجرا تنظیم می‌شود؛ بنابراین SQLite، بکاپ‌ها و لاگ‌ها بعد از redeploy
# از بین نمی‌روند. خارج از Railway رفتار قدیمی (ذخیره کنار پروژه) حفظ شده است.
DATA_DIR = os.path.abspath(
    os.getenv("DATA_DIR") or os.getenv("RAILWAY_VOLUME_MOUNT_PATH") or BASE_DIR
)
...
RESELLER_DBS_DIR = os.path.join(DATA_DIR, "reseller_dbs")
